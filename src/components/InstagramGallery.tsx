  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <a
            href="https://instagram.com/its_jeevi_signaturestacks"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block text-gold font-semibold uppercase tracking-[4px] text-xs mb-3 hover:text-rose-gold transition-colors duration-300"
          >
            @its_jeevi_signaturestacks
          </a>
          <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl md:text-5xl text-charcoal mb-4">
            Follow Us on Instagram
          </h2>
          <div className="section-divider mb-6" />
          <p className="text-muted max-w-md mx-auto text-sm leading-relaxed mb-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-gradient-to-r from-[#f09433] via-[#e6683c] to-[#dc2743] text-white text-sm font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
